...
@click.argument('folder', default='.', type=click.Path(exists=True, path_type=Path, file_okay=False), required=True)
@click.option('-d', '--delete', help='Delete newest/oldest', default='old', type=click.Choice(['new', 'old']))
@click.option('-r', '--dry-run', help='Do not delete files', is_flag=True, default=False)
@click.option('-y', '--yes', help='skip delete confirmation', is_flag=True, default=False)
